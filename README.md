...
# Тестирование 
Для тестирования используется библиотека pytest. В проекте реализовано unit и e2e-тесты. Тесты находятся в папке `avito_shop/api/pytest-tests`. Для тестирования необходимо раскоментировать в файле `.env` строку `DEBUG=true`
